...
var Dish = (function () {
    function Dish(name, price, description, prep_time, image, restaurant) {
        this.name = name;
        this.price = price;
...
var Restaurant = (function () {
    function Restaurant(name, latitude, longitude, image) {
        this.name = name;
...
var DishListComponent = (function () {
    ...
    DishListComponent.prototype.ngOnInit = function () {
        ...
        this.userForm = this.formBuilder.group({
            ...
            image: new __WEBPACK_IMPORTED_MODULE_6__angular_forms__["b" /* FormControl */]('')
        });
    };
    DishListComponent.prototype.onSubmit = function () {
        ...
        if (this.userForm.valid) {
            this.load = true;
            this.error = null;
            this.restaurantService.addDish(this.userForm.get('name').value, this.userForm.get('price').value, this.userForm.get('description').value, this.userForm.get('prep_time').value, this.userForm.get('image').value, this.restaurant).subscribe(function (serverResponse) {
                _this.restaurantService.getDishes(_this.restaurant.id_restaurant).subscribe(function (restaurantResponse) {
                    _this.dishes = restaurantResponse;
...
var RegisterRestaurantPageComponent = (function () {
    ...
    RegisterRestaurantPageComponent.prototype.ngOnInit = function () {
        ...
        this.registerRestaurantForm = this.formBuilder.group({
            ...
            image: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["b" /* FormControl */]('')
        });
    };
    RegisterRestaurantPageComponent.prototype.register = function () {
        ...
        if (this.registerRestaurantForm.valid) {
            this.load = true;
            this.error = '';
            this.restaurantService.register(this.registerRestaurantForm.get('Rname').value, this.registerRestaurantForm.get('latitude').value, this.registerRestaurantForm.get('longitude').value, this.registerRestaurantForm.get('image').value, this.userService.actualUser).subscribe(function (data) {
                _this.load = false;
...
var RestaurantEditPageComponent = (function () {
    ...
    RestaurantEditPageComponent.prototype.ngOnInit = function () {
        ...
        this.userService.find(this.authService.email).subscribe(function (userResponse) {
            ...
            _this.restaurantService.getOwner(_this.user.user_id).subscribe(function (restaurantRespose) {
                ...
                _this.image = _this.restaurant.image;
                _this.setValues();
                _this.load = false;
            });
        });
    ...
    RestaurantEditPageComponent.prototype.setValues = function () {
        this.editRestaurantForm = this.formBuilder.group({
            ...
            image: new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["b" /* FormControl */](this.image)
        });
    };
...
var RestaurantService = (function (_super) {
    ...
    RestaurantService.prototype.addDish = function (name, price, description, prep_time, image, restaurant) {
        return this.post(this.resourceUrl + restaurant.id_restaurant + '/dish', new __WEBPACK_IMPORTED_MODULE_5__models_dish__["a" /* Dish */](name, price, description, prep_time, image, restaurant));
    };
    ...
    RestaurantService.prototype.modifyDish = function (image, name, price, description, prep_time, dish) {
        this.dish = new __WEBPACK_IMPORTED_MODULE_5__models_dish__["a" /* Dish */](name, price, description, prep_time, image, dish.restaurant);
        this.dish.id_dish = dish.id_dish;
        return this.put(this.resourceUrl + dish.restaurant.id_restaurant + '/dish', this.dish);
    };
    RestaurantService.prototype.register = function (name, latitude, longitude, image, user_id) {
        this.restaurant = new __WEBPACK_IMPORTED_MODULE_6__models_restaurant__["a" /* Restaurant */](name, latitude, longitude, image);
